...
async function carregarHistorico() {
 ...
 return `
 <div class="border rounded-3 p-3 mb-2 bg-light" id="entrada-${e.id}"><div class="d-flex justify-content-between align-items-start mb-1"><div class="small text-muted">${data}</div>
...
async function iniciar() {
 ...
 <h5 class="fw-bold mb-3 mt-2">Últimas Entradas</h5><div id="historico-entradas"><p class="text-muted small">Carregando...</p></div>
 `
