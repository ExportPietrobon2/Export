...
async function carregarPedidos() {
 ...
 item.innerHTML = `
 <span class="small fw-semibold">${produto.produto}</span><div class="d-flex align-items-center gap-2"><span class="badge bg-light text-dark border" id="qtd-label-${produto.id}">${formatarQuantidade(produto.quantidade)}</span>
